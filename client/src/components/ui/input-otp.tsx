...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        "border-input relative flex h-11 w-10 items-center justify-center border-y border-e text-base shadow-xs transition-all outline-none first:rounded-s-md first:border-s last:rounded-e-md",
